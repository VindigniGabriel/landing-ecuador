        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2 lg:col-span-1">
            ...
            <p className="text-gray-300 mb-4">
              Soluciones logísticas integrales para empresas que buscan conectar oportunidades a nivel global.
            </p>
          ...
          {/* Contacto por Regiones */}
          <div>
            <h3 className="text-lg font-semibold mb-4">Contacto por Regiones</h3>
            <ul className="space-y-4">
              {/* Sierra */}
              <li>
                <p className="text-orange-400 font-medium mb-1">Región Sierra</p>
                <div className="flex items-start">
                  ...
                  <span className="text-gray-300">+593 2-299-7800</span>
                </div>
              </li>
              
              {/* Costa */}
              <li>
                <p className="text-orange-400 font-medium mb-1">Región Costa</p>
                <div className="flex items-start">
                  <svg className="h-5 w-5 mr-2 text-gray-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                  </svg>
                  <span className="text-gray-300">+593 4-371-4900</span>
                </div>
              </li>
              
              {/* Amazonía */}
              <li>
                <p className="text-orange-400 font-medium mb-1">Región Amazónica</p>
                <div className="flex items-start">
                  <svg className="h-5 w-5 mr-2 text-gray-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                  </svg>
                  <span className="text-gray-300">+593 6-288-6500</span>
                </div>
              </li>
              ...
              <li className="mt-2">
                <div className="flex items-start">
                  ...
                  <span className="text-gray-300">info@krezco.com.ec</span>
                </div>
              </li>
            </ul>
          </div>
